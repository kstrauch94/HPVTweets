...
if __name__ == "__main__":
    ...
    classifier_group.add_argument("-c", "--classifier", choices=[SVM_H, SVM_B, KNN_B, KNN_H], default=SVM_H, help="Choose classifier")
    ...
    kwargs = {1: kwargs_pre, 2: kwargs_pre, 3: kwargs_pre}
    ...
    if args.classifier == SVM_B:
        ...
        clf = TweetClassifierH(lambda: TweetClassifierBaseSVM, kwargs)
        ...
        clf = TweetClassifierH(lambda: TweetClassifierKNN, kwargs)
